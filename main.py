...
def joc_castigat(param_tabla, param_moves):
    este_castigat = False
    castigatorul = None

    for move in param_moves:
        if param_tabla[move[0]] == param_tabla[move[1]] == param_tabla[move[2]] and param_tabla[move[1]] != '':
            este_castigat = True
            castigatorul = param_tabla[move[0]]
